## JXY415 的 Mihomo/Substore 覆写规则

[![](https://data.jsdelivr.com/v1/package/gh/JXY415/override-rules/badge?style=rounded)](https://www.jsdelivr.com/package/gh/JXY415/override-rules)
...
1.  推荐直接使用 JS 动态覆写：`https://cdn.jsdelivr.net/gh/JXY415/override-rules/convert.min.js`
...
```
https://cdn.jsdelivr.net/gh/JXY415/override-rules/convert.min.js#grouptype=1
```

有链式代理和多个节点提供商之间负载均衡的需求，使用`landing=true&grouptype=2`两个参数：

```
https://cdn.jsdelivr.net/gh/JXY415/override-rules/convert.min.js#landing=true&grouptype=2
```

如果想第一时间体验最新加入的 ~~Bug~~ 功能，可以使用 preview 分支的 Github Raw 链接：

```
https://raw.githubusercontent.com/JXY415/override-rules/refs/heads/preview/convert.min.js
```
...
**获取示例（开启 full，其余关闭）：**
```text
https://cdn.jsdelivr.net/gh/JXY415/override-rules/yamls/config_gt-0_landing-0_ipv6-0_full-1_keepalive-0_fakeip-0_quic-0_tun-0.yaml
```
