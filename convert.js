/*!
Substore 订阅转换脚本（基于 powerfullz/override-rules 修改）
https://github.com/JXY415/override-rules
...
(() => {
  ...
  // src/constants.ts
  var NODE_SUFFIX, CDN_URL, REPO_SLUG, REPO_REF, PROXY_GROUPS, LOW_COST_NODE_MATCHER, LANDING_NODE_MATCHER, countriesMeta, OTHER_COUNTRIES_EXCLUDE_FILTER;
  var init_constants = __esm({
    "src/constants.ts"() {
      ...
      REPO_SLUG = "JXY415/override-rules";
      REPO_REF = "master";
      PROXY_GROUPS = {
        SELECT: "选择代理",
        MANUAL: "手动选择",
      ...
      countriesMeta = {
        ...
        越南: {
          pattern: "越南|越|\\b(?:VN|vn)(?:[-_ ]?\\d+(?:[-_ ]?[A-Za-z]{2,})?)?\\b|Vietnam|Viet Nam|河内|胡志明|🇻🇳",
      ...
      OTHER_COUNTRIES_EXCLUDE_FILTER = `(?i)${Object.values(countriesMeta).map((m) => m.pattern).join("|")}`;
    }
  });
  ...
  var init_rules = __esm({
    "src/rules.ts"() {
      ...
      baseRules = [
        ...
        `GEOSITE,category-porn,${PROXY_GROUPS.EHENTAI}`,
