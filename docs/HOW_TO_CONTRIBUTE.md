...
欢迎来到 `JXY415/override-rules`！非常感谢你愿意为本项目贡献代码或新增特性。
...
发布新版本（例如 `npm version patch/minor/major`）和创建 GitHub Releases 仅允许由项目维护者（`JXY415`）或代表其运行的授权 AI Agent 操作。请在 PR 合并后交由维护者处理版本更新。
